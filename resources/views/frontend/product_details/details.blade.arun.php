<div class="text-left">
    ...
    <div class="row align-items-center mt-1 mb-0">
        @if ($detailedProduct->auction_product != 1)
            <div class="col-auto mt-2 d-flex justify-content-start align-items-center">
                <a href="javascript:void(0)" onclick="addToCompare({{ $detailedProduct->id }})"
                class="fs-14 text-dark opacity-60 has-transitiuon hov-opacity-100">
                <i class="las la-sync mr-1"></i>{{ translate('Add to Compare') }}</a>
                <a href="javascript:void(0)" onclick="addToWishList({{ $detailedProduct->id }})"
                class="mr-3 fs-14 text-dark opacity-60 has-transitiuon hov-opacity-100 ml-3">
                <i class="la la-heart-o mr-1"></i>{{ translate('Add to Wishlist') }}</a>
            </div>
        @endif
    </div>    
                        ...
                        <div class="product-quantity d-flex align-items-center">
                            ...
                            <div class="avialable-amount opacity-60">
                                ...
                                @elseif($detailedProduct->stock_visibility_state == 'text' && $qty >= 1)
                                    (<span id="available-quantity" class="in-stock-text">{{ translate('In Stock') }}</span>)
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-3">
            @if ($detailedProduct->digital == 0)
                ...
                <button type="button" class="btn btn-secondary out-of-stock fw-600 d-none" disabled>
                    <i class="la la-cart-arrow-down out-of-stock-icon"></i> 
                    <span class="out-of-stock-text">{{ translate('Out of Stock') }}</span>
                </button>
